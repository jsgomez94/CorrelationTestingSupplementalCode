...
source("mvn_comp/11_twosample_test_jose1.R")
source("mvn_comp/20_model5.R")
source("mvn_comp/22_CreatingParameters.R")
source("mvn_comp/23_SimulationFunction.R")
...
saving_folder <- ifelse(run_type == 1, "mvn_comp/txt_exps/", "mvn_comp/txt_full/")
output_folder <- ifelse(run_type == 1, "mvn_comp/output_exps/", "mvn_comp/output_full/")
