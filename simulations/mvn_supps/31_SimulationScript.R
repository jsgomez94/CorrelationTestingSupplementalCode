...
source("mvn_supps/11_twosample_test_jose_newnorms.R")
source("mvn_supps/20_model5.R")
source("mvn_supps/22_CreatingParameters.R")
source("mvn_supps/23_SimulationFunction.R")
...
saving_folder <- ifelse(run_type == 1, "mvn_supps/txt_exps/", "mvn_supps/txt_full/")
output_folder <- ifelse(run_type == 1, "mvn_supps/output_exps/", "mvn_supps/output_full/")
